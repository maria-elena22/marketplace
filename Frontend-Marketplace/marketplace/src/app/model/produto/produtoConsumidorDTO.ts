...
import { ProdutoFornecedorInfoDTO } from './produtoFornecedorInfoDTO';


export interface ProdutoConsumidorDTO { 
    idProduto?: number;
    nome?: string;
    descricao?: string;
    iva?: ProdutoConsumidorDTO.IvaEnum;
    subCategorias?: Array<SubCategoriaDTO>;
    propriedades?: { [key: string]: string; };
    precoFornecedores?: Array<ProdutoFornecedorInfoDTO>;
}
export namespace ProdutoConsumidorDTO {
